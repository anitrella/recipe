  ...
  return (
    <div>
      ...
      <Container className="py-5 d-flex flex-column align-items-center">
        ...
        <ol>
          <li>
            <a href="">Full meal details by id</a>: per i dati su area di
            provenienza, gli ingredienti, la ricetta e la fotografia di ogni
            pasto proposto
          </li>
          <li>
            <a href="">Random meal</a>: per mostrare una ricetta casuale e di
            ispirazione nella Home
          </li>
          <li>
            <a href="">List all meal categories</a>: per creare la pagina di
            tutte le categorie, con le ricette associate
          </li>
        </ol>
      </Container>
    </div>
